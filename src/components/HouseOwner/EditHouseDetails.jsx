...
const EditHouseDetails = ({ houseDefaultValue, refetch }) => {
          ...
          <div className=" my-5">
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.availabilityDate}
                className="input input-bordered w-full"
            ...
            <div className="form-control w-full mt-3">
              ...
              <input
                ...
                defaultValue={houseDefaultValue?.description}
                className="input input-bordered w-full"
